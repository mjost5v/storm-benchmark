...
public class JoinBoltExample extends StormBenchmark {
    ...
    public static final String WINDOW_DURATION_NUM = "duration.window.in.seconds";
    ...
    public static final int DEFAULT_PRINTER_NUM = 1;

    public static final int DEFAULT_WINDOW_DURATION = 10;
    ...
    public StormTopology getTopology(Config config) {
        ...
        final int windowDurationInSeconds = BenchmarkUtils.getInt(config, WINDOW_DURATION_NUM, DEFAULT_WINDOW_DURATION);
        ...
        JoinBolt joiner = new JoinBolt(GENDER_ID, "id")
                .join(AGE_ID, "id", GENDER_ID)
                .select(String.format("%s:id,%s:id,gender,age", GENDER_ID, AGE_ID))
                .withTumblingWindow(new BaseWindowedBolt.Duration(windowDurationInSeconds, TimeUnit.SECONDS));
